...
public class ConsultaWalletGeneralVO {
	...
	public void setConsultaWalletsDinero(final 
			List<ConsultaWalletListVO> consultaWalletsDinero) {
	...
	public void setConsultaWalletsDatos(final 
			List<ConsultaWalletListVO> consultaWalletsDatos) {
	...
	public void setConsultaWalletsIlimitado(final 
	...
	public void setTotalRedesIlimitadas(final String totalRedesIlimitadas) {
