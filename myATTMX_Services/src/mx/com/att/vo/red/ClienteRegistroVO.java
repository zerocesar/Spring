...
public class ClienteRegistroVO {
	...
	public void setPreguntaSecreta(final String preguntaSecreta) {
	...
	public void setPaisID(final int paisID) {
		this.paisID = paisID;
	}
	public int getUnidadNegocioID() {
		return unidadNegocioID;
	}
	public void setUnidadNegocioID(final int unidadNegocioID) {
	...
	public void setSistemaOrigen(final int sistemaOrigen) {
